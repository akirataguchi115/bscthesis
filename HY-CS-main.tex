...
\title{NLP-hyökkäysten käyttökohteet}
...
\supervisors{FT Nikolaj Tatti}

\keywords{nlp, unicode, nlp attack, machine learning, Natural Language Processing, cyber security}
